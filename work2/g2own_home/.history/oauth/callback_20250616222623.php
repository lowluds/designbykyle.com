...
$config = [
    ...
    'user_url' => 'https://g2own.com/community/api/core/me',
...
function fetchUserData($accessToken, $config) {
    ...
    logMessage('INFO', 'Fetching user data', ['url' => $config['user_url']]);
    
    $response = file_get_contents($config['user_url'], false, $context);
