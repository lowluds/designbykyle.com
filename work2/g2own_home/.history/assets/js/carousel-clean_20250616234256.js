...
class G2OwnFeaturedCarousel {
    ...
    makeCarouselWider() {
        // Get the featured games section and its parent
        ...
        if (featuredSection && heroContainer) {
            // Make the featured games section break out of grid constraints
            ...
            // Style the game grid to be wider
            ...
            console.log('🎮 Carousel width enhanced - breaking container constraints');
        }
    }
      collectGameCards() {
