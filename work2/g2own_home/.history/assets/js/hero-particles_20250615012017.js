...
class G2OwnHeroParticles {
    constructor() {
        ...
        this.config = {
            particleCount: 80, // Increased for testing
            colors: [
                'rgba(255, 255, 255, 0.4)', // More visible white
                'rgba(239, 68, 68, 0.3)',  // More visible red
                'rgba(0, 0, 0, 0.2)',      // More visible black
                'rgba(255, 255, 255, 0.5)', // Even more visible white
                'rgba(239, 68, 68, 0.4)'   // Even more visible red
            ],
            speed: {
                min: 0.3,
                max: 1.2
            ...
            connectionOpacity: 0.1 // More visible connections
        };
