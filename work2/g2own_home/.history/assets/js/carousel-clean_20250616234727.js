...
class G2OwnFeaturedCarousel {
    constructor() {
      ...
      init() {
        ...
        if (independentCarousel) {
            // Position the carousel independently beside the hero
            ...
            console.log('🎮 Carousel positioned independently beside hero - wider and unrestricted');
        }
    }
      collectGameCards() {
