...
class G2OwnFeaturedCarousel {
    constructor() {
        this.container = document.querySelector('.hero-carousel .featured-games .game-grid');
        this.games = [];
        this.currentIndex = 0;
      ...
      makeCarouselWider() {
        // Get the hero carousel container
        const heroCarousel = this.container.closest('.hero-carousel');
        const featuredSection = this.container.closest('.featured-games-section');
        const heroContainer = this.container.closest('.hero-container');
        
        if (heroCarousel && heroContainer) {
            // Make the hero carousel take its proper grid position
            ...
            // Style the featured games section within hero
            if (featuredSection) {
            ...
            // Style the game grid for hero positioning
            ...
            console.log('🎮 Carousel positioned in hero grid - right side');
        }
    }
      collectGameCards() {
    ...
    extractGameContent(gameElement) {
      ...
      applyWideCarouselStyling() {
        ...
        if (carousel) {
            carousel.style.cssText = `
                ...
                box-shadow: 
                    ...
                    0 5px 20px rgba(255, 68, 68, 0.15),
                    inset 0 1px 0 rgba(255, 255, 255, 0.1) !important;
            `;
        }
        
        // Make cards fit the hero grid positioning
        ...
        console.log('🎨 Hero carousel styling applied');
    }
      setupEventListeners() {
      ...
      adjustCarouselWidth() {
        ...
        if (carousel && heroCarousel) {
            const screenWidth = window.innerWidth;
            
            if (screenWidth >= 1200) {
                // Desktop - fit within hero grid
                carousel.style.maxWidth = '450px';
                heroCarousel.style.maxWidth = '500px';
            } else if (screenWidth >= 768) {
                // Tablet - slightly smaller
                carousel.style.maxWidth = '400px';
                heroCarousel.style.maxWidth = '450px';
            } else {
                // Mobile - full width but smaller
                carousel.style.maxWidth = '350px';
                heroCarousel.style.maxWidth = '100%';
            }
            
            console.log(`📱 Hero carousel width adjusted for screen width: ${screenWidth}px`);
        }
    }
