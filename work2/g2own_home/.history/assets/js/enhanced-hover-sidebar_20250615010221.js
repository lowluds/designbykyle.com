...
class EnhancedHoverSidebar {
    ...
    addThemeStyles() {
        ...
        themeStyles.textContent = `
            ...
            .nav-hint:nth-child(1) { animation-delay: 0s; }
            .nav-hint:nth-child(2) { animation-delay: 0.2s; }
            .nav-hint:nth-child(3) { animation-delay: 0.4s; }
            .nav-hint:nth-child(4) { animation-delay: 0.6s; }
            .nav-hint:nth-child(5) { animation-delay: 0.8s; }
