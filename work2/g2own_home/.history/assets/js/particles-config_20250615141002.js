            ...
            particles: {
                number: {
                    ...
                    value: [
                        '#ffffff',  // Pure white
                        '#ef4444',  // G2Own red
                        '#ffffff',  // Pure white (doubled for more white particles)
                        '#dc2626',  // Deep red
                        '#ffffff',  // Pure white (tripled for balance)
                        '#f87171',  // Light red
                        '#ffffff',  // Pure white (quadrupled)
                        '#b91c1c',  // Dark red
                        '#fef2f2',  // Very light red-white
                        '#8b0000'   // Boston red
                    ]
                },
                shape: {
                ...
                size: {
                    ...
                    enable: true,
                    distance: 150,
                    color: ['#ef4444', '#ffffff', '#dc2626'], // Mixed connection colors
                    opacity: 0.4,
                    width: 1
                },
                move: {
