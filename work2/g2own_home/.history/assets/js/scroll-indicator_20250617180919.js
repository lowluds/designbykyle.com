...
class ScrollIndicatorManager {
    constructor() {
        ...
        // Simplified scroll event listener - test without throttling first
        ...
        document.addEventListener('scroll', (event) => {
            console.log('Document scroll event detected:', window.scrollY);
            this.handleScroll();
        }, { passive: true });
        ...
        console.log('Scroll indicator shown - opacity:', this.scrollIndicator.style.opacity);
    }hideIndicator() {
        if (!this.scrollIndicator) return;
