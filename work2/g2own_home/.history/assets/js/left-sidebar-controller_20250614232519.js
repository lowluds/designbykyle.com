...
class LeftSidebarController {
    ...
    updateProfileDisplay() {
        ...
        if (avatar) {
            avatar.src = this.currentUser.avatar || 'assets/images/default-avatar.jpg';
    ...
    handleSocialAuth(provider) {
        ...
        // Emit custom event
        this.emitEvent('auth:social-attempt', { provider });
        
        // Simulate social auth process
        setTimeout(() => {
            this.showNotification(`${provider} authentication would redirect to ${provider} here`, 'info');
        }, 1000);
    }
