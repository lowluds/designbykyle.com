...
class G2OwnFeaturedCarousel {
    ...
    extractGameContent(gameElement) {
      ...
      setupEventListeners() {
        ...
        if (carousel && independentCarousel) {
            ...
            if (screenWidth >= 1400) {
                ...
                // Switch to bottom positioning for tablets/mobile
                independentCarousel.style.position = 'relative';
                independentCarousel.style.transform = 'none';
            ...
            console.log(`📱 Independent carousel width adjusted for screen width: ${screenWidth}px`);
        }
    }
