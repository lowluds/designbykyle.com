...
window.G2OwnOAuthConfig = {
    ...
    oauth: {
        clientId: 'G2OWN_WEBSITE_INTEGRATION', // Production OAuth client ID - UPDATE THIS
        ...
        scope: 'authorized_user email profile', // Scopes from your Invision panel
        responseType: 'code'
    },
    ...
    frontend: {
        ...
        successURL: 'https://g2own.com/oauth/success',
        errorURL: 'https://g2own.com?error=oauth',
        logoutURL: 'https://g2own.com?logout=success'
    },
