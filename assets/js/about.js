// About Section Animations and Interactive Features
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Skill preview interactive enhancements
        ...
        timelineItems.forEach(item => {
            item.addEventListener('mouseenter', function() {
                ...
                if (icon) {
                    ...
                    icon.style.boxShadow = '0 8px 25px rgba(52, 152, 113, 0.5)';
                }
            });
            ...
            item.addEventListener('mouseleave', function() {
                ...
                if (icon) {
                    ...
                    icon.style.boxShadow = '0 5px 15px rgba(52, 152, 113, 0.3)';
                }
            });
        });
    }
    ...
    function initFloatingElements() {
        ...
        floatingItems.forEach(item => {
            // Add click interaction with bouncy animation
            item.addEventListener('click', function() {
    ...
    function createRippleEffect(element) {
        ...
        ripple.style.background = 'rgba(52, 152, 113, 0.3)';
    ...
    // Pulse animation keyframes (added via CSS)
    ...
    initAboutSection();
            ...
            // Add click interaction
            item.addEventListener('click', function() {
                this.style.animation = 'statPulse 0.6s ease-in-out';
    ...
    // Create ripple effect for highlight items
    function createHighlightRipple(element) {
        const ripple = document.createElement('div');
        const rect = element.getBoundingClientRect();
        const size = Math.max(rect.width, rect.height);
        ...
        ripple.style.cssText = `
            ...
            animation: highlightRipple 0.8s ease-out;
            pointer-events: none;
            z-index: 0;
        `;
    ...
    // Stats item click interactions
    function initStatsInteractions() {
        const statItems = document.querySelectorAll('.stat-item');
        
        statItems.forEach(item => {
            item.addEventListener('click', function() {
                // Reset and restart counter animation
    ...
    function initTextAnimations() {
        ...
        if (statsSection) {
            const statsObserver = new IntersectionObserver((entries) => {
                entries.forEach(entry => {
                    if (entry.isIntersecting) {
                        entry.target.style.animation = 'slideInRight 0.8s ease-out 0.2s both';
            ...
            statsSection.style.transform = 'translateX(30px)';
            statsObserver.observe(statsSection);
        }
    }
    
    // Helper function for counter animation (needed for stats interactions)
    ...
    // Update scroll progress to include about section
    if (window.ScrollProgress) {
        // Add about section to scroll progress tracking
        const sections = [
            { id: 'home', name: 'Home' },
            { id: 'about', name: 'About' },
        ...
        // This would be used to update the scroll progress indicators
        window.ScrollProgress.updateSections?.(sections);
    }
});
