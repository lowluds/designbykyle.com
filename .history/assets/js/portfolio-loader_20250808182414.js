                ...
                <div class="portfolio-image card-item card-item-image">
                    <a href="${project.projectUrl}" target="_blank" rel="noopener noreferrer" class="portfolio-image-link" aria-label="View ${project.title} project">
                        ...
                        <div class="portfolio-overlay">
                            <div class="portfolio-center-button card-item card-item-actions">
                                <a href="${project.projectUrl}" target="_blank" rel="noopener noreferrer" 
                                   class="portfolio-view-button" title="View Project" 
    ...
    addMouseTracking(cardElement) {
        ...
        const handleMouseMove = (e) => {
            ...
            animationFrame = requestAnimationFrame(() => {
                ...
                const rotateX = Math.max(-15, Math.min(15, (y - centerY) / centerY * -12));
                const rotateY = Math.max(-15, Math.min(15, (x - centerX) / centerX * 12));
