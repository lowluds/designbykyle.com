/*!
 * Product Display with OAuth Integration
...
class ProductDisplay {
    ...
    async loadCategories() {
        try {
            ...
            if (this.oauth.isUserAuthenticated()) {
                response = await this.oauth.makeAuthenticatedRequest(`/api/commerce/categories`);
            } else {
                response = await fetch(`/api/commerce/categories`);
            }
    ...
    async loadProducts(append = false) {
        ...
        try {
            ...
            const url = `/api/commerce/products?${params.toString()}`;
