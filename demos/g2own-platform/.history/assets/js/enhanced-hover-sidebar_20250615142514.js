...
class EnhancedHoverSidebar {
    ...
    setupButtonClickHandlers() {
        ...
        clickableButtons.forEach(button => {
            ...
            if (button.id === 'btn-register') {
                button.addEventListener('click', (e) => {
                    e.stopPropagation();                    console.log('🔥 Sign Up button clicked');
                    this.handleSignUpClick();
                });
            } else if (button.id === 'btn-signin') {
                button.addEventListener('click', (e) => {
                    e.stopPropagation();
    ...
    handleRegisterClick() {
        // You can implement registration modal or redirect here
        console.log('Opening registration...');
        alert('Registration feature - to be implemented');
    }
