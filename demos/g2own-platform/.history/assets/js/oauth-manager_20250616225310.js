...
class OAuthManager {
    ...
    /**
     * Fetch notifications (for left sidebar integration)
     */
    async fetchNotifications() {
        if (this.notifications && this.isAuthenticated()) {
            return await this.notifications.fetchNotifications();
        }
     ...
     */
    isAuthenticated() {
        return this.oauth ? this.oauth.isAuthenticated() : false;
    }
