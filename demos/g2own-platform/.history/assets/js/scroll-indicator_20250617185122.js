...
class ScrollIndicatorManager {
    constructor() {
        ...
        // Also hide hover-to-navigate during preloader
        ...
        const checkPreloader = () => {
            ...
            if (isPreloaderDone && !this.preloaderComplete) {
                // Longer delay to ensure preloader is completely gone                setTimeout(() => {
                    this.preloaderComplete = true;
                    // Add class to enable visibility for scroll indicator
                    this.scrollIndicator.classList.add('preloader-complete');
                    
                    // Also enable hover-to-navigate element
                    if (this.hoverToNavigate) {
