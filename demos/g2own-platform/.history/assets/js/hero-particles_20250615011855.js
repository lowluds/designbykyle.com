...
class G2OwnHeroParticles {
    constructor() {
        ...
        // G2Own themed particle configuration
        this.config = {
            particleCount: 60, // Very subtle amount
            colors: [
                'rgba(255, 255, 255, 0.1)', // Very feint white
                'rgba(239, 68, 68, 0.08)',  // Very feint red
                'rgba(0, 0, 0, 0.05)',      // Very feint black
                'rgba(255, 255, 255, 0.15)', // Slightly more visible white
                'rgba(239, 68, 68, 0.12)'   // Slightly more visible red
            ],
            speed: {
                min: 0.2,
                max: 0.8
            ...
            connectionOpacity: 0.03 // Very subtle connections
        };
    ...
    createParticle() {
        return {
            ...
            opacity: Math.random() * 0.5 + 0.1, // Very subtle opacity
    ...
    drawConnections() {
        this.ctx.save();
        this.ctx.strokeStyle = 'rgba(239, 68, 68, 0.05)'; // Very feint red connections
