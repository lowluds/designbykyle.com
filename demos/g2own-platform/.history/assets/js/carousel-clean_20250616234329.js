    ...
    adjustCarouselWidth() {
        ...
        if (carousel && featuredSection) {
            ...
            if (screenWidth >= 1400) {
                ...
                featuredSection.style.maxWidth = '100%';
            }
            
            console.log(`📱 Carousel width adjusted for screen width: ${screenWidth}px`);
        }
    }
