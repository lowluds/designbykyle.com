...
const OAuthConfig = {
    ...
    apiKeys: {
        authorizedUser: 'authorized_user', // For user operations requiring authentication
        menus: 'menus' // For commerce operations (store/products/purchases)
    },
    
    // Enhanced API endpoints with proper authentication requirements
    endpoints: {
        // User endpoints (require OAuth + authorized_user API key)
        userProfile: '/api/core/me',
        userDetails: '/api/core/members/{id}',
        
        // Commerce endpoints (require OAuth + menus API key)
        invoices: '/nexus/invoices',
        invoicesById: '/nexus/invoices/{id}',
        licenseKeys: '/nexus/lkey/{key}',
        licenseKeysById: '/nexus/lkey/{key}',
        purchases: '/nexus/purchases',
        purchasesById: '/nexus/purchases/{id}',
        transactions: '/nexus/transactions',
        transactionsById: '/nexus/transactions/{id}',
        
        // Store endpoints (may require menus API key)
        products: '/api/commerce/products',
        categories: '/api/commerce/categories',
