...
class G2OwnWebsite {
    ...
    // Clean up any floating elements that might appear outside containers
    cleanupFloatingElements() {
        // Hide any auth elements that might be floating outside their containers
        const floatingElements = document.querySelectorAll('body > .social-auth, body > .auth-buttons, body > .switch-text');
