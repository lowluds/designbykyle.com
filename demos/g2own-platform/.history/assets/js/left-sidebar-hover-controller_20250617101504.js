...
class EnhancedLeftSidebarController extends LeftSidebarController {
    ...
    createHoverElements() {
        ...
        this.config.previewIcons.forEach((iconConfig, index) => {
            ...
            // Force pure black background on all buttons, especially the library button (3rd one)
            icon.style.backgroundColor = '#000000';
            icon.style.background = '#000000';
            icon.style.backgroundImage = 'none';
            
            // Special care for the library button to ensure it matches others
            if (index === 2 || iconConfig.action === 'library') {
                icon.style.cssText += `
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    // Main UX Methods - Opposite of before
    hideIconsAndShowSidebar() {
        // Add transition class for smooth animations
        document.body.classList.add('sidebar-transitioning');
